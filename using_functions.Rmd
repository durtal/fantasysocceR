...
Not all of the data for each player is particularly valuable, such as photo.  However we can extract the data found in the [**players**](players.html), [**pastseasons**](pastseasons.html) datasets.  The code below shows how:
