---
title: "currentseason_df"
---

#### Description

The `currentseason_df` function converts the data found in the list returned by the [collect_ff](collect_ff.html) function when getting fresh data.  The function returns a dataframe with the performances per gameweek for the players returned in the list.
