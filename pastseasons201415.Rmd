---
title: "pastseasons201415"
---

The **pastseasons201415** dataset contains performance data for past seasons for all current players in the [fantasy.premierleague.com](http://fantasy.premierleague.com) game.  Not all players in the game have past data, such as Alexis Sanchez, these players are still included in the dataset but their performance data is recorded as `r NA`
...
The dataframe has dimensions `r dim(pastseasons201415)[1]` rows and `r dim(pastseasons201415)[2]` columns.
```{r}
